Pod::Spec.new do |spec|
    spec.name                     = 'allshared'
    spec.version                  = '0.3.5.0'
    spec.homepage                 = 'https://www.touchlab.co'
    spec.source                   = { 
                                      :http => 'https://maven.pkg.github.com/hxxyyangyong/kmmbridgedemo2/github/hxxyyangyong/kmmbridgedemo2/allshared-kmmbridge/0.3.5.0/allshared-kmmbridge-0.3.5.0.zip',
                                      :type => 'zip',
