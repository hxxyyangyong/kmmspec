Pod::Spec.new do |spec|
    ...
    spec.source                   = { 
                                      :http => 'https://maven.pkg.github.com/hxxyyangyong/kmmbridgedemo2/github/hxxyyangyong/kmmbridgedemo2/allshared-kmmbridge/0.2.5/allshared-kmmbridge-0.2.5.zip',
                                      :type => 'zip',
